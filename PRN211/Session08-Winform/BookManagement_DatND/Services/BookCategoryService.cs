...
namespace Services
{
    public class BookCategoryService
    {
        ...
        {
            //TODO: Gọi class BookCategoryRepository để lấy
            //toàn bộ danh mục phân loại sách từ DB
            //Call class BookCategoryRepository to retrieve
            //all book categories from DB
